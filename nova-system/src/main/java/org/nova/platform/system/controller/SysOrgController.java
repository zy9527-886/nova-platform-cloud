...
public class SysOrgController {
    ...
    private static final String ORG_TREE_CACHE_NAME = "'system:org:tree'";
    ...
    @Operation(description = "机构树查询（Redis 缓存 30 min）")
    @GetMapping("/tree")
    @Cacheable(value = RedisConfig.CACHE_NAME_MINUTES_30,  key = ORG_TREE_CACHE_NAME)
    public Object tree() {
    ...
    @CacheEvict(value = RedisConfig.CACHE_NAME_MINUTES_30,  key = ORG_TREE_CACHE_NAME)
